...
// Keep mock data for development/testing when API is unavailable
export const mockTributes: Tribute[] = [
  ...
  },
  {
    ...
    shared_by: 'Robert Wilson',
  },
];

// Note: Gallery images now come from /api/gallery (tributes with images)
// This is kept only for reference/fallback and is no longer used in production
